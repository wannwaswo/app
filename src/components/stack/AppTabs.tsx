...
export default function AppTabs() {
  ...
  return (
    ...
    >
      ...
      />
      <Tab.Screen
        options={{ title: "Trending", headerLeft: () => (
          <TouchableHighlight onPress={() => navigate.navigate(Routes.SETTINGS.ROOT)} style={{ padding: 5 }}>
            <View>
            <Svg fill="#000000" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" height={28} width={28}>
